...
class SaleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.SaleTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id_sale', 'IdSale', 'INTEGER', true, null, null);
        $this->addForeignKey('id_account', 'IdAccount', 'INTEGER', 'account', 'id_account', true, null, null);
        $this->addColumn('date', 'Date', 'TIMESTAMP', false, null, null);
        $this->addColumn('statut', 'Statut', 'ENUM', false, null, 'Acceptée');
  ...
  1 => 'Refusée',
    ...
    {
        $this->addRelation('Account', 'Account', RelationMap::MANY_TO_ONE, array('id_account' => 'id_account', ), 'CASCADE', null);
            $this->addRelation('Abonnement', 'Abonnement', RelationMap::ONE_TO_MANY, array('id_sale' => 'id_sale', ), 'CASCADE', null, 'Abonnements');
    } // buildRelations()
  ...
  'child_colunms' => '{"id_account": ["email"]}',
  'child_table' => '["abonnement"]',
  'order_list' => '[["id_account","ASC"]]',
  'search_items' => '{"search":{"Compte":[["id_account", "%val"]]}}',
