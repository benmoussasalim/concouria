...
/**
 * This class defines the structure of the 'content_i18n_version' table.
 *
 *
 *
 ...
 */
class ContentI18nVersionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.ContentI18nVersionTableMap';
    ...
    {
        // attributes
        $this->setName('content_i18n_version');
        $this->setPhpName('ContentI18nVersion');
        $this->setClassname('ContentI18nVersion');
        $this->setPackage('gen');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_content_i18n_version', 'IdContentI18nVersion', 'INTEGER', true, null, null);
        $this->addForeignKey('id_content', 'IdContent', 'INTEGER', 'content', 'id_content', true, null, null);
