...
/**
 * This class defines the structure of the 'province_i18n' table.
 *
 *
 *
 ...
 */
class ProvinceI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.ProvinceI18nTableMap';
    ...
    {
        // attributes
        $this->setName('province_i18n');
        $this->setPhpName('ProvinceI18n');
        $this->setClassname('ProvinceI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_province', 'IdProvince', 'INTEGER' , 'province', 'id_province', true, null, null);
