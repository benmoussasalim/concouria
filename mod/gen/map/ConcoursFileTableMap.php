...
/**
 * This class defines the structure of the 'concours_file' table.
 *
 *
 *
 ...
 */
class ConcoursFileTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.ConcoursFileTableMap';
    ...
    {
        // attributes
        $this->setName('concours_file');
        $this->setPhpName('ConcoursFile');
        $this->setClassname('ConcoursFile');
        $this->setPackage('gen');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_concours_file', 'IdConcoursFile', 'INTEGER', true, null, null);
        $this->addForeignKey('id_concours', 'IdConcours', 'INTEGER', 'concours', 'id_concours', true, null, null);
    ...
    {
        $this->addRelation('Concours', 'Concours', RelationMap::MANY_TO_ONE, array('id_concours' => 'id_concours', ), 'CASCADE', null);
    } // buildRelations()
  ...
  'file_upload' => '{     "thumbnail": "Yes",     "filters" : {      "max_file_size" : "20mb",      "mime_types": [       {"title" : "images", "extensions" : "jpg,png"}      ]     },     "image_support":"yes"    }',
  'order_list' => '[["name","ASC"]]',
