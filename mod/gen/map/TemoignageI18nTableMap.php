...
/**
 * This class defines the structure of the 'temoignage_i18n' table.
 *
 *
 *
 ...
 */
class TemoignageI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.TemoignageI18nTableMap';
    ...
    {
        // attributes
        $this->setName('temoignage_i18n');
        $this->setPhpName('TemoignageI18n');
        $this->setClassname('TemoignageI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_temoignage', 'IdTemoignage', 'INTEGER' , 'temoignage', 'id_temoignage', true, null, null);
    ...
    {
        $this->addRelation('Temoignage', 'Temoignage', RelationMap::MANY_TO_ONE, array('id_temoignage' => 'id_temoignage', ), 'CASCADE', null);
    } // buildRelations()
