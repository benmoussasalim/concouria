...
class VilleI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.VilleI18nTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('VilleI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_ville', 'IdVille', 'INTEGER' , 'ville', 'id_ville', true, null, null);
    ...
    {
        $this->addRelation('Ville', 'Ville', RelationMap::MANY_TO_ONE, array('id_ville' => 'id_ville', ), 'CASCADE', null);
    } // buildRelations()
