...
class RegionI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.RegionI18nTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('RegionI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_region', 'IdRegion', 'INTEGER' , 'region', 'id_region', true, null, null);
