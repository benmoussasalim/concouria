...
/**
 * This class defines the structure of the 'taxe_i18n' table.
 *
 *
 *
 ...
 */
class TaxeI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.TaxeI18nTableMap';
    ...
    {
        // attributes
        $this->setName('taxe_i18n');
        $this->setPhpName('TaxeI18n');
        $this->setClassname('TaxeI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_taxe', 'IdTaxe', 'INTEGER' , 'taxe', 'id_taxe', true, null, null);
    ...
    {
        $this->addRelation('Taxe', 'Taxe', RelationMap::MANY_TO_ONE, array('id_taxe' => 'id_taxe', ), 'CASCADE', null);
    } // buildRelations()
