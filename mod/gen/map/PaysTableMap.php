...
class PaysTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.PaysTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Pays');
        $this->setPackage('gen');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_pays', 'IdPays', 'INTEGER', true, null, null);
    ...
    {
            $this->addRelation('Account', 'Account', RelationMap::ONE_TO_MANY, array('id_pays' => 'id_pays', ), null, null, 'Accounts');
            $this->addRelation('Province', 'Province', RelationMap::ONE_TO_MANY, array('id_pays' => 'id_pays', ), 'CASCADE', null, 'Provinces');
            $this->addRelation('PaysI18n', 'PaysI18n', RelationMap::ONE_TO_MANY, array('id_pays' => 'id_pays', ), 'CASCADE', null, 'PaysI18ns');
    } // buildRelations()
  ...
  'list_columns_hide_excep' => '["title"]',
  'search_items' => '{"search":{"Pays":[["title", "%val"]]}}',
  'sub_table_visible' => '60',
