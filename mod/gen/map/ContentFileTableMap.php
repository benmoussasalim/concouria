...
/**
 * This class defines the structure of the 'content_file' table.
 *
 *
 *
...
class ContentFileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.ContentFileTableMap';
    ...
    {
        // attributes
        $this->setName('content_file');
        $this->setPhpName('ContentFile');
        $this->setClassname('ContentFile');
        $this->setPackage('gen');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_content_file', 'IdContentFile', 'INTEGER', true, null, null);
        ...
        $this->addColumn('current', 'Current', 'ENUM', true, null, null);
        $this->getColumn('current', false)->setValueSet(array (
  0 => 'Non',
  1 => 'Oui',
));
