...
class FaqTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.FaqTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id_faq', 'IdFaq', 'INTEGER', true, null, null);
  ...
  1 => 'Non',
    ...
    {
            $this->addRelation('FaqI18n', 'FaqI18n', RelationMap::ONE_TO_MANY, array('id_faq' => 'id_faq', ), 'CASCADE', null, 'FaqI18ns');
    } // buildRelations()
