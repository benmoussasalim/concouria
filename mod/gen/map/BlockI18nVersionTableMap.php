...
/**
 * This class defines the structure of the 'block_i18n_version' table.
 *
 *
 *
 ...
 */
class BlockI18nVersionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.BlockI18nVersionTableMap';
    ...
    {
        // attributes
        $this->setName('block_i18n_version');
        $this->setPhpName('BlockI18nVersion');
        $this->setClassname('BlockI18nVersion');
        $this->setPackage('gen');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_block_i18n_version', 'IdBlockI18nVersion', 'INTEGER', true, null, null);
