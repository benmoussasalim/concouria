...
/**
 * This class defines the structure of the 'block_i18n' table.
 *
 *
 *
 ...
 */
class BlockI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.BlockI18nTableMap';
    ...
    {
        // attributes
        $this->setName('block_i18n');
        $this->setPhpName('BlockI18n');
        $this->setClassname('BlockI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_block', 'IdBlock', 'INTEGER' , 'block', 'id_block', true, null, null);
