...
/**
 * This class defines the structure of the 'slider_i18n' table.
 *
 *
 *
 ...
 */
class SliderI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.SliderI18nTableMap';
    ...
    {
        // attributes
        $this->setName('slider_i18n');
        $this->setPhpName('SliderI18n');
        $this->setClassname('SliderI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_slider', 'IdSlider', 'INTEGER' , 'slider', 'id_slider', true, null, null);
