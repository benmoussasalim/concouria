...
class RegionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.RegionTableMap';
    ...
    public function buildRelations()
    {
        $this->addRelation('Province', 'Province', RelationMap::MANY_TO_ONE, array('id_province' => 'id_province', ), 'CASCADE', null);
            $this->addRelation('Account', 'Account', RelationMap::ONE_TO_MANY, array('id_region' => 'id_region', ), null, null, 'Accounts');
            $this->addRelation('Ville', 'Ville', RelationMap::ONE_TO_MANY, array('id_region' => 'id_region', ), 'CASCADE', null, 'Villes');
            $this->addRelation('RegionI18n', 'RegionI18n', RelationMap::ONE_TO_MANY, array('id_region' => 'id_region', ), 'CASCADE', null, 'RegionI18ns');
    } // buildRelations()
  ...
  'child_colunms' => '{"id_province": ["title"]}',
  'list_columns_hide_excep' => '["title","id_province"]',
  'search_items' => '{"search":{"Région":[["title", "%val"]],"Province":[["id_province", "%val"]]}}',
  'sub_table_visible' => '80',
