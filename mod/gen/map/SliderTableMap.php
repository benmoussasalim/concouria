...
class SliderTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.SliderTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id_slider', 'IdSlider', 'INTEGER', true, null, null);
        $this->addColumn('title', 'Title', 'VARCHAR', true, 200, null);
        $this->addColumn('online', 'Online', 'ENUM', true, null, 'Oui');
  ...
  1 => 'Non',
    ...
    {
            $this->addRelation('SliderFile', 'SliderFile', RelationMap::ONE_TO_MANY, array('id_slider' => 'id_slider', ), 'CASCADE', null, 'SliderFiles');
            $this->addRelation('SliderI18n', 'SliderI18n', RelationMap::ONE_TO_MANY, array('id_slider' => 'id_slider', ), 'CASCADE', null, 'SliderI18ns');
    } // buildRelations()
  ...
  'list_columns_hide_excep' => '[  "title",  "text",  "order","online"]',
