...
class ContentI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.ContentI18nTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addForeignPrimaryKey('id_content', 'IdContent', 'INTEGER' , 'content', 'id_content', true, null, null);
        ...
        $this->addColumn('meta_keyword', 'MetaKeyword', 'LONGVARCHAR', true, null, null);
        $this->addColumn('meta_description', 'MetaDescription', 'LONGVARCHAR', true, null, null);
        $this->addColumn('meta_title', 'MetaTitle', 'LONGVARCHAR', true, null, null);
