...
/**
 * This class defines the structure of the 'slider_file' table.
 *
 *
 *
 ...
 */
class SliderFileTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.SliderFileTableMap';
    ...
    {
        // attributes
        $this->setName('slider_file');
        $this->setPhpName('SliderFile');
        $this->setClassname('SliderFile');
        $this->setPackage('gen');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_slider_file', 'IdSliderFile', 'INTEGER', true, null, null);
        $this->addForeignKey('id_slider', 'IdSlider', 'INTEGER', 'slider', 'id_slider', true, null, null);
    ...
    {
        $this->addRelation('Slider', 'Slider', RelationMap::MANY_TO_ONE, array('id_slider' => 'id_slider', ), 'CASCADE', null);
    } // buildRelations()
  ...
  'file_upload' => '{     "thumbnail": "Yes",     "filters" : {      "max_file_size" : "10mb",      "mime_types": [       {"title" : "images", "extensions" : "jpg,png"}      ]     },     "image_support":"yes"    }',
  'order_list' => '[["name","ASC"]]',
