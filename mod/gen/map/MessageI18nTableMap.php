...
class MessageI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.MessageI18nTableMap';
    ...
    {
        $this->addRelation('Message', 'Message', RelationMap::MANY_TO_ONE, array('id_message' => 'id_message', ), 'CASCADE', null);
    } // buildRelations()
