...
/**
 * This class defines the structure of the 'statistique_i18n' table.
 *
 *
 *
 ...
 */
class StatistiqueI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.StatistiqueI18nTableMap';
    ...
    {
        // attributes
        $this->setName('statistique_i18n');
        $this->setPhpName('StatistiqueI18n');
        $this->setClassname('StatistiqueI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_statistique', 'IdStatistique', 'INTEGER' , 'statistique', 'id_statistique', true, null, null);
    ...
    {
        $this->addRelation('Statistique', 'Statistique', RelationMap::MANY_TO_ONE, array('id_statistique' => 'id_statistique', ), 'CASCADE', null);
    } // buildRelations()
