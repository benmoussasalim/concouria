...
/**
 * This class defines the structure of the 'concours_i18n' table.
 *
 *
 *
 ...
 */
class ConcoursI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.ConcoursI18nTableMap';
    ...
    {
        // attributes
        $this->setName('concours_i18n');
        $this->setPhpName('ConcoursI18n');
        $this->setClassname('ConcoursI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_concours', 'IdConcours', 'INTEGER' , 'concours', 'id_concours', true, null, null);
