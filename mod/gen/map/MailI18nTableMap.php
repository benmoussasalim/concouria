...
class MailI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'gen.map.MailI18nTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addForeignPrimaryKey('id_mail', 'IdMail', 'INTEGER' , 'mail', 'id_mail', true, null, null);
    ...
    {
        $this->addRelation('Mail', 'Mail', RelationMap::MANY_TO_ONE, array('id_mail' => 'id_mail', ), 'CASCADE', null);
    } // buildRelations()
