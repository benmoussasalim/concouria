...
/**
 * This class defines the structure of the 'month_winner_i18n' table.
 *
 *
 *
 ...
 */
class MonthWinnerI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.MonthWinnerI18nTableMap';
    ...
    {
        // attributes
        $this->setName('month_winner_i18n');
        $this->setPhpName('MonthWinnerI18n');
        $this->setClassname('MonthWinnerI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_month_winner', 'IdMonthWinner', 'INTEGER' , 'month_winner', 'id_month_winner', true, null, null);
    ...
    {
        $this->addRelation('MonthWinner', 'MonthWinner', RelationMap::MANY_TO_ONE, array('id_month_winner' => 'id_month_winner', ), 'CASCADE', null);
    } // buildRelations()
