...
/**
 * This class defines the structure of the 'faq_i18n' table.
 *
 *
 *
 ...
 */
class FaqI18nTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'gen.map.FaqI18nTableMap';
    ...
    {
        // attributes
        $this->setName('faq_i18n');
        $this->setPhpName('FaqI18n');
        $this->setClassname('FaqI18n');
        $this->setPackage('gen');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('id_faq', 'IdFaq', 'INTEGER' , 'faq', 'id_faq', true, null, null);
    ...
    {
        $this->addRelation('Faq', 'Faq', RelationMap::MANY_TO_ONE, array('id_faq' => 'id_faq', ), 'CASCADE', null);
    } // buildRelations()
