...
abstract class BaseMessagePeer
{
    ...
    const DATE_CREATION = 'message.date_creation';

    const DATE_MODIFICATION = 'message.date_modification';

    const ID_CREATION = 'message.id_creation';

    const ID_MODIFICATION = 'message.id_modification';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdMessage', 'Label', 'DateCreation', 'DateModification', 'IdCreation', 'IdModification', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idMessage', 'label', 'dateCreation', 'dateModification', 'idCreation', 'idModification', ),
        BasePeer::TYPE_COLNAME => array (MessagePeer::ID_MESSAGE, MessagePeer::LABEL, MessagePeer::DATE_CREATION, MessagePeer::DATE_MODIFICATION, MessagePeer::ID_CREATION, MessagePeer::ID_MODIFICATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_MESSAGE', 'LABEL', 'DATE_CREATION', 'DATE_MODIFICATION', 'ID_CREATION', 'ID_MODIFICATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id_message', 'label', 'date_creation', 'date_modification', 'id_creation', 'id_modification', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdMessage' => 0, 'Label' => 1, 'DateCreation' => 2, 'DateModification' => 3, 'IdCreation' => 4, 'IdModification' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idMessage' => 0, 'label' => 1, 'dateCreation' => 2, 'dateModification' => 3, 'idCreation' => 4, 'idModification' => 5, ),
        BasePeer::TYPE_COLNAME => array (MessagePeer::ID_MESSAGE => 0, MessagePeer::LABEL => 1, MessagePeer::DATE_CREATION => 2, MessagePeer::DATE_MODIFICATION => 3, MessagePeer::ID_CREATION => 4, MessagePeer::ID_MODIFICATION => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_MESSAGE' => 0, 'LABEL' => 1, 'DATE_CREATION' => 2, 'DATE_MODIFICATION' => 3, 'ID_CREATION' => 4, 'ID_MODIFICATION' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id_message' => 0, 'label' => 1, 'date_creation' => 2, 'date_modification' => 3, 'id_creation' => 4, 'id_modification' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MessagePeer::ID_CREATION);
            $criteria->addSelectColumn(MessagePeer::ID_MODIFICATION);
        } else {
