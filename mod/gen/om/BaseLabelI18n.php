...
/**
 * Base class that represents a row from the 'label_i18n' table.
 *
 *
 *
 * @package    propel.generator.gen.om
 */
abstract class BaseLabelI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'LabelI18nPeer';
    ...
    /**
     * Initializes internal state of BaseLabelI18n object.
     * @see        applyDefaults()
     */
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(LabelI18nPeer::DATE_CREATION);
        try {
            $stmt = LabelI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(LabelI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = LabelI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdLabel($v)
    {
        ...
        if ($this->id_label !== $v) {
            $this->id_label = $v;
            $this->modifiedColumns[] = LabelI18nPeer::ID_LABEL;
        }

        if ($this->aLabel !== null && $this->aLabel->getIdLabel() !== $v) {
            $this->aLabel = null;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = LabelI18nPeer::LOCALE;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = LabelI18nPeer::TEXT;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = LabelI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = LabelI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = LabelI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = LabelI18nPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = LabelI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LabelI18n object", $e);
        }
    }
    ...
    public function ensureConsistency(){
        ...
        if ($this->aLabel !== null && $this->id_label !== $this->aLabel->getIdLabel()) {
            $this->aLabel = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(LabelI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.
        $stmt = LabelI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='LabelI18n';}
        $needeRight='d';
        ...
        if ($con === null) { $con = Propel::getConnection(LabelI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = LabelI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->commit();
            LabelI18nPeer::addInstanceToPool($this);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LabelI18nPeer::ID_LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`id_label`';
        }
        if ($this->isColumnModified(LabelI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(LabelI18nPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(LabelI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(LabelI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(LabelI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(LabelI18nPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `label_i18n` (%s) VALUES (%s)',
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if ($this->aLabel !== null) {
                if (!$this->aLabel->validate($columns)) {$failureMap = array_merge($failureMap, $this->aLabel->getValidationFailures()); }
            }

            if (($retval = LabelI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        $pos = LabelI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LabelI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LabelI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = LabelI18nPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LabelI18nPeer::ID_LABEL)) $criteria->add(LabelI18nPeer::ID_LABEL, $this->id_label);
        if ($this->isColumnModified(LabelI18nPeer::LOCALE)) $criteria->add(LabelI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(LabelI18nPeer::TEXT)) $criteria->add(LabelI18nPeer::TEXT, $this->text);
        if ($this->isColumnModified(LabelI18nPeer::DATE_CREATION)) $criteria->add(LabelI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(LabelI18nPeer::DATE_MODIFICATION)) $criteria->add(LabelI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(LabelI18nPeer::ID_CREATION)) $criteria->add(LabelI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(LabelI18nPeer::ID_MODIFICATION)) $criteria->add(LabelI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(LabelI18nPeer::DATABASE_NAME);
        $criteria->add(LabelI18nPeer::ID_LABEL, $this->id_label);
        $criteria->add(LabelI18nPeer::LOCALE, $this->locale);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdLabel()) && (null === $this->getLocale());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of LabelI18n (or compatible) type.
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @param boolean $makeNew Whether to reset autoincrement PKs and make the object new.
     * @throws PropelException
     */
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true){
        $copyObj->setIdLabel($this->getIdLabel());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LabelI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LabelI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LabelI18nPeer();
        }
    ...
    /**
     * Declares an association between this object and a Label object.
     *
     * @param                  Label $v
     * @return LabelI18n The current object (for fluent API support)
     * @throws PropelException
     */
    public function setLabel(Label $v = null)
    {
        if ($v === null) {
            $this->setIdLabel(NULL);
        } else {
            $this->setIdLabel($v->getIdLabel());
        }

        $this->aLabel = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Label object, it will not be re-added.
        if ($v !== null) {
            $v->addLabelI18n($this);
        }
    ...
    /**
     * Get the associated Label object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Label The associated Label object.
     * @throws PropelException
     */
    public function getLabel(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLabel === null && ($this->id_label !== null) && $doQuery) {
            $this->aLabel = LabelQuery::create()->findPk($this->id_label, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLabel->addLabelI18ns($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aLabel instanceof Persistent) {
              $this->aLabel->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(LabelI18nPeer::DEFAULT_STRING_FORMAT);
    }
