...
/**
 * Base class that represents a row from the 'slider_i18n' table.
 *
 *
 *
 * @package    propel.generator.gen.om
 */
abstract class BaseSliderI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'SliderI18nPeer';
    ...
    /**
     * Initializes internal state of BaseSliderI18n object.
     * @see        applyDefaults()
     */
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(SliderI18nPeer::DATE_CREATION);
        try {
            $stmt = SliderI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(SliderI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = SliderI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdSlider($v)
    {
        ...
        if ($this->id_slider !== $v) {
            $this->id_slider = $v;
            $this->modifiedColumns[] = SliderI18nPeer::ID_SLIDER;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = SliderI18nPeer::LOCALE;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = SliderI18nPeer::TEXT;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = SliderI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = SliderI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = SliderI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = SliderI18nPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = SliderI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SliderI18n object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(SliderI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.
        $stmt = SliderI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='SliderI18n';}
        $needeRight='d';
        ...
        mem_clean('SliderI18n');

        if ($this->isDeleted()) { throw new PropelException("This object has already been deleted.");}
        if ($con === null) { $con = Propel::getConnection(SliderI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = SliderI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->commit();
            SliderI18nPeer::addInstanceToPool($this);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SliderI18nPeer::ID_SLIDER)) {
            $modifiedColumns[':p' . $index++]  = '`id_slider`';
        }
        if ($this->isColumnModified(SliderI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(SliderI18nPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(SliderI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(SliderI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(SliderI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(SliderI18nPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `slider_i18n` (%s) VALUES (%s)',
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = SliderI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        $pos = SliderI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SliderI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SliderI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = SliderI18nPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SliderI18nPeer::ID_SLIDER)) $criteria->add(SliderI18nPeer::ID_SLIDER, $this->id_slider);
        if ($this->isColumnModified(SliderI18nPeer::LOCALE)) $criteria->add(SliderI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(SliderI18nPeer::TEXT)) $criteria->add(SliderI18nPeer::TEXT, $this->text);
        if ($this->isColumnModified(SliderI18nPeer::DATE_CREATION)) $criteria->add(SliderI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(SliderI18nPeer::DATE_MODIFICATION)) $criteria->add(SliderI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(SliderI18nPeer::ID_CREATION)) $criteria->add(SliderI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(SliderI18nPeer::ID_MODIFICATION)) $criteria->add(SliderI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(SliderI18nPeer::DATABASE_NAME);
        $criteria->add(SliderI18nPeer::ID_SLIDER, $this->id_slider);
        $criteria->add(SliderI18nPeer::LOCALE, $this->locale);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdSlider()) && (null === $this->getLocale());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of SliderI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SliderI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SliderI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SliderI18nPeer();
        }
    ...
    public function getSlider(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSlider === null && ($this->id_slider !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSlider->addSliderI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SliderI18nPeer::DEFAULT_STRING_FORMAT);
    }
