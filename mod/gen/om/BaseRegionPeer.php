...
abstract class BaseRegionPeer
{
    ...
    const ID_REGION = 'region.id_region';

    const ID_PROVINCE = 'region.id_province';

    const TITLE = 'region.title';

    const DATE_CREATION = 'region.date_creation';

    const DATE_MODIFICATION = 'region.date_modification';

    const ID_CREATION = 'region.id_creation';

    const ID_MODIFICATION = 'region.id_modification';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdRegion', 'IdProvince', 'Title', 'DateCreation', 'DateModification', 'IdCreation', 'IdModification', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idRegion', 'idProvince', 'title', 'dateCreation', 'dateModification', 'idCreation', 'idModification', ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID_REGION, RegionPeer::ID_PROVINCE, RegionPeer::TITLE, RegionPeer::DATE_CREATION, RegionPeer::DATE_MODIFICATION, RegionPeer::ID_CREATION, RegionPeer::ID_MODIFICATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_REGION', 'ID_PROVINCE', 'TITLE', 'DATE_CREATION', 'DATE_MODIFICATION', 'ID_CREATION', 'ID_MODIFICATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id_region', 'id_province', 'title', 'date_creation', 'date_modification', 'id_creation', 'id_modification', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdRegion' => 0, 'IdProvince' => 1, 'Title' => 2, 'DateCreation' => 3, 'DateModification' => 4, 'IdCreation' => 5, 'IdModification' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idRegion' => 0, 'idProvince' => 1, 'title' => 2, 'dateCreation' => 3, 'dateModification' => 4, 'idCreation' => 5, 'idModification' => 6, ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID_REGION => 0, RegionPeer::ID_PROVINCE => 1, RegionPeer::TITLE => 2, RegionPeer::DATE_CREATION => 3, RegionPeer::DATE_MODIFICATION => 4, RegionPeer::ID_CREATION => 5, RegionPeer::ID_MODIFICATION => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_REGION' => 0, 'ID_PROVINCE' => 1, 'TITLE' => 2, 'DATE_CREATION' => 3, 'DATE_MODIFICATION' => 4, 'ID_CREATION' => 5, 'ID_MODIFICATION' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id_region' => 0, 'id_province' => 1, 'title' => 2, 'date_creation' => 3, 'date_modification' => 4, 'id_creation' => 5, 'id_modification' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RegionPeer::ID_REGION);
            $criteria->addSelectColumn(RegionPeer::ID_PROVINCE);
            $criteria->addSelectColumn(RegionPeer::TITLE);
            $criteria->addSelectColumn(RegionPeer::ID_CREATION);
            $criteria->addSelectColumn(RegionPeer::ID_MODIFICATION);
        } else {
    ...
    public static function doCountJoinProvince(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(RegionPeer::ID_PROVINCE, ProvincePeer::ID_PROVINCE, $join_behavior);
    ...
    public static function doSelectJoinProvince(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Region) to $obj2 (Province)
                $obj2->addRegion($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Region) to the collection in $obj2 (Province)
                $obj2->addRegion($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(RegionPeer::ID_REGION) && $criteria->keyContainsValue(RegionPeer::ID_REGION) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(RegionPeer::ID_REGION);
            $value = $criteria->remove(RegionPeer::ID_REGION);
            if ($value) {
                $selectCriteria->add(RegionPeer::ID_REGION, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(RegionPeer::ID_REGION, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(RegionPeer::DATABASE_NAME);
        $criteria->add(RegionPeer::ID_REGION, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(RegionPeer::DATABASE_NAME);
            $criteria->add(RegionPeer::ID_REGION, $pks, Criteria::IN);
