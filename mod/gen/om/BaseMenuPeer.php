...
abstract class BaseMenuPeer
{
    ...
    const DATE_CREATION = 'menu.date_creation';

    const DATE_MODIFICATION = 'menu.date_modification';

    const ID_CREATION = 'menu.id_creation';

    const ID_MODIFICATION = 'menu.id_modification';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdMenu', 'Title', 'Order', 'DateCreation', 'DateModification', 'IdCreation', 'IdModification', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idMenu', 'title', 'order', 'dateCreation', 'dateModification', 'idCreation', 'idModification', ),
        BasePeer::TYPE_COLNAME => array (MenuPeer::ID_MENU, MenuPeer::TITLE, MenuPeer::ORDER, MenuPeer::DATE_CREATION, MenuPeer::DATE_MODIFICATION, MenuPeer::ID_CREATION, MenuPeer::ID_MODIFICATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_MENU', 'TITLE', 'ORDER', 'DATE_CREATION', 'DATE_MODIFICATION', 'ID_CREATION', 'ID_MODIFICATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id_menu', 'title', 'order', 'date_creation', 'date_modification', 'id_creation', 'id_modification', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdMenu' => 0, 'Title' => 1, 'Order' => 2, 'DateCreation' => 3, 'DateModification' => 4, 'IdCreation' => 5, 'IdModification' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idMenu' => 0, 'title' => 1, 'order' => 2, 'dateCreation' => 3, 'dateModification' => 4, 'idCreation' => 5, 'idModification' => 6, ),
        BasePeer::TYPE_COLNAME => array (MenuPeer::ID_MENU => 0, MenuPeer::TITLE => 1, MenuPeer::ORDER => 2, MenuPeer::DATE_CREATION => 3, MenuPeer::DATE_MODIFICATION => 4, MenuPeer::ID_CREATION => 5, MenuPeer::ID_MODIFICATION => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_MENU' => 0, 'TITLE' => 1, 'ORDER' => 2, 'DATE_CREATION' => 3, 'DATE_MODIFICATION' => 4, 'ID_CREATION' => 5, 'ID_MODIFICATION' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id_menu' => 0, 'title' => 1, 'order' => 2, 'date_creation' => 3, 'date_modification' => 4, 'id_creation' => 5, 'id_modification' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MenuPeer::ID_MENU);
            $criteria->addSelectColumn(MenuPeer::TITLE);
            $criteria->addSelectColumn(MenuPeer::ORDER);
            $criteria->addSelectColumn(MenuPeer::ID_CREATION);
            $criteria->addSelectColumn(MenuPeer::ID_MODIFICATION);
        } else {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(MenuPeer::ID_MENU) && $criteria->keyContainsValue(MenuPeer::ID_MENU) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(MenuPeer::ID_MENU);
            $value = $criteria->remove(MenuPeer::ID_MENU);
            if ($value) {
                $selectCriteria->add(MenuPeer::ID_MENU, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MenuPeer::ID_MENU, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(MenuPeer::DATABASE_NAME);
        $criteria->add(MenuPeer::ID_MENU, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(MenuPeer::DATABASE_NAME);
            $criteria->add(MenuPeer::ID_MENU, $pks, Criteria::IN);
