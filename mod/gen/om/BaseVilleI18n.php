...
abstract class BaseVilleI18n extends BaseObject implements Persistent
{
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(VilleI18nPeer::DATE_CREATION);
        try {
            $stmt = VilleI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(VilleI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = VilleI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdVille($v)
    {
        ...
        if ($this->id_ville !== $v) {
            $this->id_ville = $v;
            $this->modifiedColumns[] = VilleI18nPeer::ID_VILLE;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = VilleI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = VilleI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = VilleI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = VilleI18nPeer::ID_MODIFICATION;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(VilleI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='VilleI18n';}
        $needeRight='d';
        ...
        if ($con === null) { $con = Propel::getConnection(VilleI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = VilleI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VilleI18nPeer::ID_VILLE)) {
        ...
        if ($this->isColumnModified(VilleI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(VilleI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(VilleI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(VilleI18nPeer::ID_MODIFICATION)) {
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = VilleI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VilleI18nPeer::ID_VILLE)) $criteria->add(VilleI18nPeer::ID_VILLE, $this->id_ville);
        ...
        if ($this->isColumnModified(VilleI18nPeer::DATE_CREATION)) $criteria->add(VilleI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(VilleI18nPeer::DATE_MODIFICATION)) $criteria->add(VilleI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(VilleI18nPeer::ID_CREATION)) $criteria->add(VilleI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(VilleI18nPeer::ID_MODIFICATION)) $criteria->add(VilleI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(VilleI18nPeer::DATABASE_NAME);
        $criteria->add(VilleI18nPeer::ID_VILLE, $this->id_ville);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdVille()) && (null === $this->getLocale());
    }
