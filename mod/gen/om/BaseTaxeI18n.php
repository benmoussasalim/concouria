...
/**
 * Base class that represents a row from the 'taxe_i18n' table.
 *
 *
 *
 * @package    propel.generator.gen.om
 */
abstract class BaseTaxeI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TaxeI18nPeer';
    ...
    /**
     * Initializes internal state of BaseTaxeI18n object.
     * @see        applyDefaults()
     */
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(TaxeI18nPeer::DATE_CREATION);
        try {
            $stmt = TaxeI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(TaxeI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = TaxeI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdTaxe($v)
    {
        ...
        if ($this->id_taxe !== $v) {
            $this->id_taxe = $v;
            $this->modifiedColumns[] = TaxeI18nPeer::ID_TAXE;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = TaxeI18nPeer::LOCALE;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = TaxeI18nPeer::TITLE;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = TaxeI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = TaxeI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = TaxeI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = TaxeI18nPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = TaxeI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TaxeI18n object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(TaxeI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.
        $stmt = TaxeI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='TaxeI18n';}
        $needeRight='d';
        ...
        if ($con === null) { $con = Propel::getConnection(TaxeI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = TaxeI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->commit();
            TaxeI18nPeer::addInstanceToPool($this);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TaxeI18nPeer::ID_TAXE)) {
            $modifiedColumns[':p' . $index++]  = '`id_taxe`';
        }
        if ($this->isColumnModified(TaxeI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(TaxeI18nPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(TaxeI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(TaxeI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(TaxeI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(TaxeI18nPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `taxe_i18n` (%s) VALUES (%s)',
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = TaxeI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        $pos = TaxeI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TaxeI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TaxeI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = TaxeI18nPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaxeI18nPeer::ID_TAXE)) $criteria->add(TaxeI18nPeer::ID_TAXE, $this->id_taxe);
        if ($this->isColumnModified(TaxeI18nPeer::LOCALE)) $criteria->add(TaxeI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(TaxeI18nPeer::TITLE)) $criteria->add(TaxeI18nPeer::TITLE, $this->title);
        if ($this->isColumnModified(TaxeI18nPeer::DATE_CREATION)) $criteria->add(TaxeI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(TaxeI18nPeer::DATE_MODIFICATION)) $criteria->add(TaxeI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(TaxeI18nPeer::ID_CREATION)) $criteria->add(TaxeI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(TaxeI18nPeer::ID_MODIFICATION)) $criteria->add(TaxeI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(TaxeI18nPeer::DATABASE_NAME);
        $criteria->add(TaxeI18nPeer::ID_TAXE, $this->id_taxe);
        $criteria->add(TaxeI18nPeer::LOCALE, $this->locale);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdTaxe()) && (null === $this->getLocale());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TaxeI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TaxeI18n Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(TaxeI18nPeer::DEFAULT_STRING_FORMAT);
    }
