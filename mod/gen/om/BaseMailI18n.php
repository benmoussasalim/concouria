...
abstract class BaseMailI18n extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BaseMailI18n object.
     * @see        applyDefaults()
     */
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(MailI18nPeer::DATE_CREATION);
        try {
            $stmt = MailI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(MailI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = MailI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdMail($v)
    {
        ...
        if ($this->id_mail !== $v) {
            $this->id_mail = $v;
            $this->modifiedColumns[] = MailI18nPeer::ID_MAIL;
        }

        if ($this->aMail !== null && $this->aMail->getIdMail() !== $v) {
            $this->aMail = null;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = MailI18nPeer::LOCALE;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = MailI18nPeer::TEXT;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = MailI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = MailI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = MailI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = MailI18nPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = MailI18nPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency(){
        ...
        if ($this->aMail !== null && $this->id_mail !== $this->aMail->getIdMail()) {
            $this->aMail = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(MailI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='MailI18n';}
        $needeRight='d';
        ...
        if ($con === null) { $con = Propel::getConnection(MailI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = MailI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MailI18nPeer::ID_MAIL)) {
            $modifiedColumns[':p' . $index++]  = '`id_mail`';
        }
        if ($this->isColumnModified(MailI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(MailI18nPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(MailI18nPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(MailI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(MailI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(MailI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(MailI18nPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `mail_i18n` (%s) VALUES (%s)',
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if ($this->aMail !== null) {
                if (!$this->aMail->validate($columns)) {$failureMap = array_merge($failureMap, $this->aMail->getValidationFailures()); }
            }

            if (($retval = MailI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        if (isset($alreadyDumpedObjects['MailI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MailI18n'][serialize($this->getPrimaryKey())] = true;
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aMail) {
                $result['Mail'] = $this->aMail->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MailI18nPeer::ID_MAIL)) $criteria->add(MailI18nPeer::ID_MAIL, $this->id_mail);
        if ($this->isColumnModified(MailI18nPeer::LOCALE)) $criteria->add(MailI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(MailI18nPeer::TITLE)) $criteria->add(MailI18nPeer::TITLE, $this->title);
        if ($this->isColumnModified(MailI18nPeer::TEXT)) $criteria->add(MailI18nPeer::TEXT, $this->text);
        if ($this->isColumnModified(MailI18nPeer::DATE_CREATION)) $criteria->add(MailI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(MailI18nPeer::DATE_MODIFICATION)) $criteria->add(MailI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(MailI18nPeer::ID_CREATION)) $criteria->add(MailI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(MailI18nPeer::ID_MODIFICATION)) $criteria->add(MailI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(MailI18nPeer::DATABASE_NAME);
        $criteria->add(MailI18nPeer::ID_MAIL, $this->id_mail);
        $criteria->add(MailI18nPeer::LOCALE, $this->locale);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdMail()) && (null === $this->getLocale());
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true){
        $copyObj->setIdMail($this->getIdMail());
     ...
     * @throws PropelException
     */
    public function getMail(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMail === null && ($this->id_mail !== null) && $doQuery) {
            $this->aMail = MailQuery::create()->findPk($this->id_mail, $con);
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aMail instanceof Persistent) {
              $this->aMail->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(MailI18nPeer::DEFAULT_STRING_FORMAT);
    }
