...
abstract class BaseVille extends BaseObject implements Persistent
{
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(VillePeer::DATE_CREATION);
        try {
            $stmt = VillePeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(VillePeer::DATE_MODIFICATION);
        try {
            $stmt = VillePeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdVille($v)
    {
        ...
        if ($this->id_ville !== $v) {
            $this->id_ville = $v;
            $this->modifiedColumns[] = VillePeer::ID_VILLE;
        }
    ...
    public function setIdRegion($v)
    {
        ...
        if ($this->id_region !== $v) {
            $this->id_region = $v;
            $this->modifiedColumns[] = VillePeer::ID_REGION;
        }
    ...
    public function setIdProvince($v)
    {
        ...
        if ($this->id_province !== $v) {
            $this->id_province = $v;
            $this->modifiedColumns[] = VillePeer::ID_PROVINCE;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = VillePeer::TITLE;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = VillePeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = VillePeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = VillePeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = VillePeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_ville = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->id_region = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->id_province = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(VillePeer::DATABASE_NAME, Propel::CONNECTION_READ);}
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='Ville';}
        $needeRight='d';
        ...
        if ($con === null) { $con = Propel::getConnection(VillePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = VilleQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = VillePeer::ID_VILLE;
        if (null !== $this->id_ville) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . VillePeer::ID_VILLE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(VillePeer::ID_VILLE)) {
            $modifiedColumns[':p' . $index++]  = '`id_ville`';
        }
        if ($this->isColumnModified(VillePeer::ID_REGION)) {
            $modifiedColumns[':p' . $index++]  = '`id_region`';
        }
        if ($this->isColumnModified(VillePeer::ID_PROVINCE)) {
            $modifiedColumns[':p' . $index++]  = '`id_province`';
        }
        if ($this->isColumnModified(VillePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(VillePeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(VillePeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(VillePeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(VillePeer::ID_MODIFICATION)) {
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = VillePeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getIdRegion(),
            $keys[2] => $this->getIdProvince(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdVille($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setIdRegion($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setIdProvince($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VillePeer::ID_VILLE)) $criteria->add(VillePeer::ID_VILLE, $this->id_ville);
        if ($this->isColumnModified(VillePeer::ID_REGION)) $criteria->add(VillePeer::ID_REGION, $this->id_region);
        if ($this->isColumnModified(VillePeer::ID_PROVINCE)) $criteria->add(VillePeer::ID_PROVINCE, $this->id_province);
        if ($this->isColumnModified(VillePeer::TITLE)) $criteria->add(VillePeer::TITLE, $this->title);
        if ($this->isColumnModified(VillePeer::DATE_CREATION)) $criteria->add(VillePeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(VillePeer::DATE_MODIFICATION)) $criteria->add(VillePeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(VillePeer::ID_CREATION)) $criteria->add(VillePeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(VillePeer::ID_MODIFICATION)) $criteria->add(VillePeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(VillePeer::DATABASE_NAME);
        $criteria->add(VillePeer::ID_VILLE, $this->id_ville);
    ...
    /**
     * Generic method to set the primary key (id_ville column).
     *
        ...
        if (null === $this->collVilleI18ns || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collVilleI18ns) {
                ...
                if (null !== $criteria) {
                    ...
                    $collVilleI18ns->getInternalIterator()->rewind();
    ...
    {
        $villeI18nsToDelete = $this->getVilleI18ns(new Criteria(), $con)->diff($villeI18ns);


        //since at least one column in the foreign key is at the same time a PK
        //we can not just set a PK to NULL in the lines below. We have to store
        //a backup of all values, so we are able to manipulate these items based on the onDelete value later.
        $this->villeI18nsScheduledForDeletion = clone $villeI18nsToDelete;

        foreach ($villeI18nsToDelete as $villeI18nRemoved) {
    ...
    public function addVilleI18n(VilleI18n $l)
    {
        ...
        if (!in_array($l, $this->collVilleI18ns->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->villeI18nsScheduledForDeletion and $this->villeI18nsScheduledForDeletion->contains($l)) {
                $this->villeI18nsScheduledForDeletion->remove($this->villeI18nsScheduledForDeletion->search($l));
            }
        }
    ...
    public function removeVilleI18n($villeI18n)
    {
        if ($this->getVilleI18ns()->contains($villeI18n)) {
            ...
            $this->villeI18nsScheduledForDeletion[]= clone $villeI18n;
