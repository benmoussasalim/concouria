...
/**
 * Base class that represents a row from the 'content_i18n_version' table.
 *
 *
 *
 * @package    propel.generator.gen.om
 */
abstract class BaseContentI18nVersion extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ContentI18nVersionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ContentI18nVersionPeer
     */
    ...
    /**
     * The value for the id_content_i18n_version field.
     * @var        int
     */
    protected $id_content_i18n_version;
    ...
    /**
     * Get the [id_content_i18n_version] column value.
     *
     * @return int
     */
    public function getIdContentI18nVersion()
    {

        return $this->id_content_i18n_version;
    }
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(ContentI18nVersionPeer::DATE_CREATION);
        try {
            $stmt = ContentI18nVersionPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(ContentI18nVersionPeer::DATE_MODIFICATION);
        try {
            $stmt = ContentI18nVersionPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    /**
     * Set the value of [id_content_i18n_version] column.
     *
     * @param  int $v new value
     * @return ContentI18nVersion The current object (for fluent API support)
     */
    public function setIdContentI18nVersion($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_content_i18n_version !== $v) {
            $this->id_content_i18n_version = $v;
            $this->modifiedColumns[] = ContentI18nVersionPeer::ID_CONTENT_I18N_VERSION;
        }


        return $this;
    } // setIdContentI18nVersion()
    ...
    public function setIdContent($v)
    {
        ...
        if ($this->id_content !== $v) {
            $this->id_content = $v;
            $this->modifiedColumns[] = ContentI18nVersionPeer::ID_CONTENT;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = ContentI18nVersionPeer::LOCALE;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = ContentI18nVersionPeer::TEXT;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = ContentI18nVersionPeer::VERSION;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = ContentI18nVersionPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = ContentI18nVersionPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = ContentI18nVersionPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = ContentI18nVersionPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_content_i18n_version = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 7; // 7 = ContentI18nVersionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ContentI18nVersion object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(ContentI18nVersionPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.
        $stmt = ContentI18nVersionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='ContentI18nVersion';}
        $needeRight='d';
        ...
        mem_clean('ContentI18nVersion');

        if ($this->isDeleted()) { throw new PropelException("This object has already been deleted.");}
        if ($con === null) { $con = Propel::getConnection(ContentI18nVersionPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = ContentI18nVersionQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->commit();
            ContentI18nVersionPeer::addInstanceToPool($this);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ContentI18nVersionPeer::ID_CONTENT_I18N_VERSION;
        if (null !== $this->id_content_i18n_version) {
        ...
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_CONTENT_I18N_VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`id_content_i18n_version`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_content`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `content_i18n_version` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_content_i18n_version`':
                        $stmt->bindValue($identifier, $this->id_content_i18n_version, PDO::PARAM_INT);
                        break;
                    case '`id_content`':
        ...
        $this->setIdContentI18nVersion($pk);
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = ContentI18nVersionPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        $pos = ContentI18nVersionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ContentI18nVersion'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ContentI18nVersion'][$this->getPrimaryKey()] = true;
        $keys = ContentI18nVersionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdContentI18nVersion(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdContentI18nVersion($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdContentI18nVersion($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_CONTENT_I18N_VERSION)) $criteria->add(ContentI18nVersionPeer::ID_CONTENT_I18N_VERSION, $this->id_content_i18n_version);
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_CONTENT)) $criteria->add(ContentI18nVersionPeer::ID_CONTENT, $this->id_content);
        if ($this->isColumnModified(ContentI18nVersionPeer::LOCALE)) $criteria->add(ContentI18nVersionPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(ContentI18nVersionPeer::TEXT)) $criteria->add(ContentI18nVersionPeer::TEXT, $this->text);
        if ($this->isColumnModified(ContentI18nVersionPeer::VERSION)) $criteria->add(ContentI18nVersionPeer::VERSION, $this->version);
        if ($this->isColumnModified(ContentI18nVersionPeer::DATE_CREATION)) $criteria->add(ContentI18nVersionPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(ContentI18nVersionPeer::DATE_MODIFICATION)) $criteria->add(ContentI18nVersionPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_CREATION)) $criteria->add(ContentI18nVersionPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(ContentI18nVersionPeer::ID_MODIFICATION)) $criteria->add(ContentI18nVersionPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(ContentI18nVersionPeer::DATABASE_NAME);
        $criteria->add(ContentI18nVersionPeer::ID_CONTENT_I18N_VERSION, $this->id_content_i18n_version);
    ...
    {
        return $this->getIdContentI18nVersion();
    }

    /**
     * Generic method to set the primary key (id_content_i18n_version column).
     *
    ...
    {
        $this->setIdContentI18nVersion($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdContentI18nVersion();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ContentI18nVersion (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true){
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdContentI18nVersion(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ContentI18nVersion Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ContentI18nVersionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ContentI18nVersionPeer();
        }
    ...
    public function getContent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aContent === null && ($this->id_content !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContent->addContentI18nVersions($this);
             */
        }
    ...
    {
        $this->id_content_i18n_version = null;
    ...
    {
        return (string) $this->exportTo(ContentI18nVersionPeer::DEFAULT_STRING_FORMAT);
    }
