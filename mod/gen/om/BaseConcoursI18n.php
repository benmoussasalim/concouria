...
/**
 * Base class that represents a row from the 'concours_i18n' table.
 *
 *
 *
 * @package    propel.generator.gen.om
 */
abstract class BaseConcoursI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ConcoursI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ConcoursI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseConcoursI18n object.
     * @see        applyDefaults()
     */
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(ConcoursI18nPeer::DATE_CREATION);
        try {
            $stmt = ConcoursI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(ConcoursI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = ConcoursI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdConcours($v)
    {
        ...
        if ($this->id_concours !== $v) {
            $this->id_concours = $v;
            $this->modifiedColumns[] = ConcoursI18nPeer::ID_CONCOURS;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = ConcoursI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ConcoursI18nPeer::NAME;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = ConcoursI18nPeer::TEXT;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = ConcoursI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = ConcoursI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = ConcoursI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = ConcoursI18nPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ConcoursI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ConcoursI18n object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(ConcoursI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.
        $stmt = ConcoursI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='ConcoursI18n';}
        $needeRight='d';
        ...
        mem_clean('ConcoursI18n');

        if ($this->isDeleted()) { throw new PropelException("This object has already been deleted.");}
        if ($con === null) { $con = Propel::getConnection(ConcoursI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = ConcoursI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->commit();
            ConcoursI18nPeer::addInstanceToPool($this);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ConcoursI18nPeer::ID_CONCOURS)) {
            $modifiedColumns[':p' . $index++]  = '`id_concours`';
        }
        if ($this->isColumnModified(ConcoursI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(ConcoursI18nPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ConcoursI18nPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(ConcoursI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(ConcoursI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(ConcoursI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(ConcoursI18nPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `concours_i18n` (%s) VALUES (%s)',
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = ConcoursI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        $pos = ConcoursI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ConcoursI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ConcoursI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = ConcoursI18nPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConcoursI18nPeer::ID_CONCOURS)) $criteria->add(ConcoursI18nPeer::ID_CONCOURS, $this->id_concours);
        if ($this->isColumnModified(ConcoursI18nPeer::LOCALE)) $criteria->add(ConcoursI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(ConcoursI18nPeer::NAME)) $criteria->add(ConcoursI18nPeer::NAME, $this->name);
        if ($this->isColumnModified(ConcoursI18nPeer::TEXT)) $criteria->add(ConcoursI18nPeer::TEXT, $this->text);
        if ($this->isColumnModified(ConcoursI18nPeer::DATE_CREATION)) $criteria->add(ConcoursI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(ConcoursI18nPeer::DATE_MODIFICATION)) $criteria->add(ConcoursI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(ConcoursI18nPeer::ID_CREATION)) $criteria->add(ConcoursI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(ConcoursI18nPeer::ID_MODIFICATION)) $criteria->add(ConcoursI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(ConcoursI18nPeer::DATABASE_NAME);
        $criteria->add(ConcoursI18nPeer::ID_CONCOURS, $this->id_concours);
        $criteria->add(ConcoursI18nPeer::LOCALE, $this->locale);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdConcours()) && (null === $this->getLocale());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ConcoursI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ConcoursI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ConcoursI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ConcoursI18nPeer();
        }
    ...
    public function getConcours(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aConcours === null && ($this->id_concours !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aConcours->addConcoursI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ConcoursI18nPeer::DEFAULT_STRING_FORMAT);
    }
