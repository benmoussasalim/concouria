...
abstract class BaseRegionI18nQuery extends ModelCriteria
{
    ...
    {
        if ($criteria instanceof RegionI18nQuery) {return $criteria;}
        $query = new RegionI18nQuery(null, null, $modelAlias);
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$id_region, $locale]
    ...
    {
        $sql = 'SELECT `id_region`, `locale`, `name`, `id_creation`, `id_modification` FROM `region_i18n` WHERE `id_region` = :p0 AND `locale` = :p1';
        try {
    ...
    {
        $this->addUsingAlias(RegionI18nPeer::ID_REGION, $key[0], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(RegionI18nPeer::ID_REGION, $key[0], Criteria::EQUAL);
    ...
    public function filterByIdRegion($idRegion = null, $comparison = null)
    {
        if (is_array($idRegion)) {
            ...
            if (isset($idRegion['min'])) {
                $this->addUsingAlias(RegionI18nPeer::ID_REGION, $idRegion['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idRegion['max'])) {
                $this->addUsingAlias(RegionI18nPeer::ID_REGION, $idRegion['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionI18nPeer::ID_REGION, $idRegion, $comparison);
    }
    ...
    public function filterByDateCreation($dateCreation = null, $comparison = null)
    {
        if (is_array($dateCreation)) {
            ...
            if (isset($dateCreation['min'])) {
                $this->addUsingAlias(RegionI18nPeer::DATE_CREATION, $dateCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateCreation['max'])) {
                $this->addUsingAlias(RegionI18nPeer::DATE_CREATION, $dateCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionI18nPeer::DATE_CREATION, $dateCreation, $comparison);
    }
    ...
    public function filterByDateModification($dateModification = null, $comparison = null)
    {
        if (is_array($dateModification)) {
            ...
            if (isset($dateModification['min'])) {
                $this->addUsingAlias(RegionI18nPeer::DATE_MODIFICATION, $dateModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateModification['max'])) {
                $this->addUsingAlias(RegionI18nPeer::DATE_MODIFICATION, $dateModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionI18nPeer::DATE_MODIFICATION, $dateModification, $comparison);
    }
    ...
    public function filterByIdCreation($idCreation = null, $comparison = null)
    {
        if (is_array($idCreation)) {
            ...
            if (isset($idCreation['min'])) {
                $this->addUsingAlias(RegionI18nPeer::ID_CREATION, $idCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idCreation['max'])) {
                $this->addUsingAlias(RegionI18nPeer::ID_CREATION, $idCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionI18nPeer::ID_CREATION, $idCreation, $comparison);
    }
    ...
    public function filterByIdModification($idModification = null, $comparison = null)
    {
        if (is_array($idModification)) {
            ...
            if (isset($idModification['min'])) {
                $this->addUsingAlias(RegionI18nPeer::ID_MODIFICATION, $idModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idModification['max'])) {
                $this->addUsingAlias(RegionI18nPeer::ID_MODIFICATION, $idModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionI18nPeer::ID_MODIFICATION, $idModification, $comparison);
    }
    ...
    public function filterByRegion($region, $comparison = null)
    {
        if ($region instanceof Region) {
            return $this
                ->addUsingAlias(RegionI18nPeer::ID_REGION, $region->getIdRegion(), $comparison);
            ...
            return $this
                ->addUsingAlias(RegionI18nPeer::ID_REGION, $region->toKeyValue('PrimaryKey', 'IdRegion'), $comparison);
        } else {
    ...
    {
        if ($regionI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(RegionI18nPeer::ID_REGION), $regionI18n->getIdRegion(), Criteria::NOT_EQUAL);
    ...
    public function recentlyUpdated($nbDays = 7){
        return $this->addUsingAlias(RegionI18nPeer::DATE_MODIFICATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastUpdatedFirst(){
        return $this->addDescendingOrderByColumn(RegionI18nPeer::DATE_MODIFICATION);
    }
    ...
    public function firstUpdatedFirst(){
        return $this->addAscendingOrderByColumn(RegionI18nPeer::DATE_MODIFICATION);
    }
    ...
    public function recentlyCreated($nbDays = 7){
        return $this->addUsingAlias(RegionI18nPeer::DATE_CREATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastCreatedFirst(){
        return $this->addDescendingOrderByColumn(RegionI18nPeer::DATE_CREATION);
    }
    ...
    public function firstCreatedFirst(){
        return $this->addAscendingOrderByColumn(RegionI18nPeer::DATE_CREATION);
    }
}
