...
abstract class BaseVilleQuery extends ModelCriteria
{
    ...
    {
        if ($criteria instanceof VilleQuery) {return $criteria;}
        $query = new VilleQuery(null, null, $modelAlias);
     ...
     */
     public function findOneByIdVille($key, $con = null)
     {
    ...
    {
        $sql = 'SELECT `id_ville`, `id_region`, `id_province`, `title`, `id_creation`, `id_modification` FROM `ville` WHERE `id_ville` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(VillePeer::ID_VILLE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(VillePeer::ID_VILLE, $keys, Criteria::IN);
    }
    ...
    public function filterByIdVille($idVille = null, $comparison = null)
    {
        if (is_array($idVille)) {
            ...
            if (isset($idVille['min'])) {
                $this->addUsingAlias(VillePeer::ID_VILLE, $idVille['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idVille['max'])) {
                $this->addUsingAlias(VillePeer::ID_VILLE, $idVille['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VillePeer::ID_VILLE, $idVille, $comparison);
    }
    ...
    public function filterByIdRegion($idRegion = null, $comparison = null)
    {
        if (is_array($idRegion)) {
            ...
            if (isset($idRegion['min'])) {
                $this->addUsingAlias(VillePeer::ID_REGION, $idRegion['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idRegion['max'])) {
                $this->addUsingAlias(VillePeer::ID_REGION, $idRegion['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VillePeer::ID_REGION, $idRegion, $comparison);
    }
    ...
    public function filterByIdProvince($idProvince = null, $comparison = null)
    {
        if (is_array($idProvince)) {
            ...
            if (isset($idProvince['min'])) {
                $this->addUsingAlias(VillePeer::ID_PROVINCE, $idProvince['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idProvince['max'])) {
                $this->addUsingAlias(VillePeer::ID_PROVINCE, $idProvince['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VillePeer::ID_PROVINCE, $idProvince, $comparison);
    }
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VillePeer::TITLE, $title, $comparison);
    }
    ...
    public function filterByDateCreation($dateCreation = null, $comparison = null)
    {
        if (is_array($dateCreation)) {
            ...
            if (isset($dateCreation['min'])) {
                $this->addUsingAlias(VillePeer::DATE_CREATION, $dateCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateCreation['max'])) {
                $this->addUsingAlias(VillePeer::DATE_CREATION, $dateCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VillePeer::DATE_CREATION, $dateCreation, $comparison);
    }
    ...
    public function filterByDateModification($dateModification = null, $comparison = null)
    {
        if (is_array($dateModification)) {
            ...
            if (isset($dateModification['min'])) {
                $this->addUsingAlias(VillePeer::DATE_MODIFICATION, $dateModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateModification['max'])) {
                $this->addUsingAlias(VillePeer::DATE_MODIFICATION, $dateModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VillePeer::DATE_MODIFICATION, $dateModification, $comparison);
    }
    ...
    public function filterByIdCreation($idCreation = null, $comparison = null)
    {
        if (is_array($idCreation)) {
            ...
            if (isset($idCreation['min'])) {
                $this->addUsingAlias(VillePeer::ID_CREATION, $idCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idCreation['max'])) {
                $this->addUsingAlias(VillePeer::ID_CREATION, $idCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VillePeer::ID_CREATION, $idCreation, $comparison);
    }
    ...
    public function filterByIdModification($idModification = null, $comparison = null)
    {
        if (is_array($idModification)) {
            ...
            if (isset($idModification['min'])) {
                $this->addUsingAlias(VillePeer::ID_MODIFICATION, $idModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idModification['max'])) {
                $this->addUsingAlias(VillePeer::ID_MODIFICATION, $idModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VillePeer::ID_MODIFICATION, $idModification, $comparison);
    }
    ...
    public function filterByRegion($region, $comparison = null)
    {
        if ($region instanceof Region) {
            return $this
                ->addUsingAlias(VillePeer::ID_REGION, $region->getIdRegion(), $comparison);
            ...
            return $this
                ->addUsingAlias(VillePeer::ID_REGION, $region->toKeyValue('PrimaryKey', 'IdRegion'), $comparison);
        } else {
    ...
    public function filterByProvince($province, $comparison = null)
    {
        if ($province instanceof Province) {
            return $this
                ->addUsingAlias(VillePeer::ID_PROVINCE, $province->getIdProvince(), $comparison);
            ...
            return $this
                ->addUsingAlias(VillePeer::ID_PROVINCE, $province->toKeyValue('PrimaryKey', 'IdProvince'), $comparison);
        } else {
    ...
    public function filterByAccount($account, $comparison = null)
    {
        if ($account instanceof Account) {
            return $this
                ->addUsingAlias(VillePeer::ID_VILLE, $account->getIdVille(), $comparison);
    ...
    public function filterByVilleI18n($villeI18n, $comparison = null)
    {
        if ($villeI18n instanceof VilleI18n) {
            return $this
                ->addUsingAlias(VillePeer::ID_VILLE, $villeI18n->getIdVille(), $comparison);
    ...
    public function useVilleI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'VilleI18n', 'VilleI18nQuery');
    }
    ...
    {
        if ($ville) {
            $this->addUsingAlias(VillePeer::ID_VILLE, $ville->getIdVille(), Criteria::NOT_EQUAL);
        }
    ...
    public function recentlyUpdated($nbDays = 7){
        return $this->addUsingAlias(VillePeer::DATE_MODIFICATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastUpdatedFirst(){
        return $this->addDescendingOrderByColumn(VillePeer::DATE_MODIFICATION);
    }
    ...
    public function firstUpdatedFirst(){
        return $this->addAscendingOrderByColumn(VillePeer::DATE_MODIFICATION);
    }
    ...
    public function recentlyCreated($nbDays = 7){
        return $this->addUsingAlias(VillePeer::DATE_CREATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastCreatedFirst(){
        return $this->addDescendingOrderByColumn(VillePeer::DATE_CREATION);
    }
    ...
    public function firstCreatedFirst(){
        return $this->addAscendingOrderByColumn(VillePeer::DATE_CREATION);
    }
}
