...
abstract class BaseConfigQuery extends ModelCriteria
{
    ...
    {
        if ($criteria instanceof ConfigQuery) {return $criteria;}
    ...
    {
        $sql = 'SELECT `id_config`, `config`, `value`, `system`, `description`, `type`, `id_creation`, `id_modification` FROM `config` WHERE `id_config` = :p0';
        try {
