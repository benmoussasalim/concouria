...
abstract class BasePaysQuery extends ModelCriteria
{
    ...
    {
        if ($criteria instanceof PaysQuery) {return $criteria;}
        $query = new PaysQuery(null, null, $modelAlias);
     ...
     */
     public function findOneByIdPays($key, $con = null)
     {
    ...
    {
        $sql = 'SELECT `id_pays`, `title`, `id_creation`, `id_modification` FROM `pays` WHERE `id_pays` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PaysPeer::ID_PAYS, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PaysPeer::ID_PAYS, $keys, Criteria::IN);
    }
    ...
    public function filterByIdPays($idPays = null, $comparison = null)
    {
        if (is_array($idPays)) {
            $useMinMax = false;
            if (isset($idPays['min'])) {
                $this->addUsingAlias(PaysPeer::ID_PAYS, $idPays['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idPays['max'])) {
                $this->addUsingAlias(PaysPeer::ID_PAYS, $idPays['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PaysPeer::ID_PAYS, $idPays, $comparison);
    }
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaysPeer::TITLE, $title, $comparison);
    }
    ...
    public function filterByDateCreation($dateCreation = null, $comparison = null)
    {
        if (is_array($dateCreation)) {
            ...
            if (isset($dateCreation['min'])) {
                $this->addUsingAlias(PaysPeer::DATE_CREATION, $dateCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateCreation['max'])) {
                $this->addUsingAlias(PaysPeer::DATE_CREATION, $dateCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PaysPeer::DATE_CREATION, $dateCreation, $comparison);
    }
    ...
    public function filterByDateModification($dateModification = null, $comparison = null)
    {
        if (is_array($dateModification)) {
            ...
            if (isset($dateModification['min'])) {
                $this->addUsingAlias(PaysPeer::DATE_MODIFICATION, $dateModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateModification['max'])) {
                $this->addUsingAlias(PaysPeer::DATE_MODIFICATION, $dateModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PaysPeer::DATE_MODIFICATION, $dateModification, $comparison);
    }
    ...
    public function filterByIdCreation($idCreation = null, $comparison = null)
    {
        if (is_array($idCreation)) {
            ...
            if (isset($idCreation['min'])) {
                $this->addUsingAlias(PaysPeer::ID_CREATION, $idCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idCreation['max'])) {
                $this->addUsingAlias(PaysPeer::ID_CREATION, $idCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PaysPeer::ID_CREATION, $idCreation, $comparison);
    }
    ...
    public function filterByIdModification($idModification = null, $comparison = null)
    {
        if (is_array($idModification)) {
            ...
            if (isset($idModification['min'])) {
                $this->addUsingAlias(PaysPeer::ID_MODIFICATION, $idModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idModification['max'])) {
                $this->addUsingAlias(PaysPeer::ID_MODIFICATION, $idModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PaysPeer::ID_MODIFICATION, $idModification, $comparison);
    }
    ...
    public function filterByAccount($account, $comparison = null)
    {
        if ($account instanceof Account) {
            return $this
                ->addUsingAlias(PaysPeer::ID_PAYS, $account->getIdPays(), $comparison);
    ...
    public function filterByProvince($province, $comparison = null)
    {
        if ($province instanceof Province) {
            return $this
                ->addUsingAlias(PaysPeer::ID_PAYS, $province->getIdPays(), $comparison);
    ...
    public function filterByPaysI18n($paysI18n, $comparison = null)
    {
        if ($paysI18n instanceof PaysI18n) {
            return $this
                ->addUsingAlias(PaysPeer::ID_PAYS, $paysI18n->getIdPays(), $comparison);
    ...
    public function usePaysI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PaysI18n', 'PaysI18nQuery');
    }
    ...
    {
        if ($pays) {
            $this->addUsingAlias(PaysPeer::ID_PAYS, $pays->getIdPays(), Criteria::NOT_EQUAL);
        }
    ...
    public function recentlyUpdated($nbDays = 7){
        return $this->addUsingAlias(PaysPeer::DATE_MODIFICATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastUpdatedFirst(){
        return $this->addDescendingOrderByColumn(PaysPeer::DATE_MODIFICATION);
    }
    ...
    public function firstUpdatedFirst(){
        return $this->addAscendingOrderByColumn(PaysPeer::DATE_MODIFICATION);
    }
    ...
    public function recentlyCreated($nbDays = 7){
        return $this->addUsingAlias(PaysPeer::DATE_CREATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastCreatedFirst(){
        return $this->addDescendingOrderByColumn(PaysPeer::DATE_CREATION);
    }
    ...
    public function firstCreatedFirst(){
        return $this->addAscendingOrderByColumn(PaysPeer::DATE_CREATION);
    }
}
