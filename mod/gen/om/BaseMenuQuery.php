...
abstract class BaseMenuQuery extends ModelCriteria
{
    ...
    {
        if ($criteria instanceof MenuQuery) {return $criteria;}
    ...
    {
        $sql = 'SELECT `id_menu`, `title`, `order`, `id_creation`, `id_modification` FROM `menu` WHERE `id_menu` = :p0';
        try {
    ...
    public function filterByIdMenu($idMenu = null, $comparison = null)
    {
        if (is_array($idMenu)) {
            $useMinMax = false;
            if (isset($idMenu['min'])) {
                $this->addUsingAlias(MenuPeer::ID_MENU, $idMenu['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idMenu['max'])) {
                $this->addUsingAlias(MenuPeer::ID_MENU, $idMenu['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByOrder($order = null, $comparison = null)
    {
        if (is_array($order)) {
            $useMinMax = false;
            if (isset($order['min'])) {
                $this->addUsingAlias(MenuPeer::ORDER, $order['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($order['max'])) {
                $this->addUsingAlias(MenuPeer::ORDER, $order['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MenuPeer::ORDER, $order, $comparison);
    }
    ...
    public function filterByDateCreation($dateCreation = null, $comparison = null)
    {
        if (is_array($dateCreation)) {
            ...
            if (isset($dateCreation['min'])) {
                $this->addUsingAlias(MenuPeer::DATE_CREATION, $dateCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateCreation['max'])) {
                $this->addUsingAlias(MenuPeer::DATE_CREATION, $dateCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MenuPeer::DATE_CREATION, $dateCreation, $comparison);
    }
    ...
    public function filterByDateModification($dateModification = null, $comparison = null)
    {
        if (is_array($dateModification)) {
            ...
            if (isset($dateModification['min'])) {
                $this->addUsingAlias(MenuPeer::DATE_MODIFICATION, $dateModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateModification['max'])) {
                $this->addUsingAlias(MenuPeer::DATE_MODIFICATION, $dateModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MenuPeer::DATE_MODIFICATION, $dateModification, $comparison);
    }
    ...
    public function filterByIdCreation($idCreation = null, $comparison = null)
    {
        if (is_array($idCreation)) {
            ...
            if (isset($idCreation['min'])) {
                $this->addUsingAlias(MenuPeer::ID_CREATION, $idCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idCreation['max'])) {
                $this->addUsingAlias(MenuPeer::ID_CREATION, $idCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MenuPeer::ID_CREATION, $idCreation, $comparison);
    }
    ...
    public function filterByIdModification($idModification = null, $comparison = null)
    {
        if (is_array($idModification)) {
            ...
            if (isset($idModification['min'])) {
                $this->addUsingAlias(MenuPeer::ID_MODIFICATION, $idModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idModification['max'])) {
                $this->addUsingAlias(MenuPeer::ID_MODIFICATION, $idModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MenuPeer::ID_MODIFICATION, $idModification, $comparison);
    }
    ...
    public function filterByContent($content, $comparison = null)
    {
        if ($content instanceof Content) {
            return $this
                ->addUsingAlias(MenuPeer::ID_MENU, $content->getIdMenu(), $comparison);
    ...
    public function recentlyUpdated($nbDays = 7){
        return $this->addUsingAlias(MenuPeer::DATE_MODIFICATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastUpdatedFirst(){
        return $this->addDescendingOrderByColumn(MenuPeer::DATE_MODIFICATION);
    }
    ...
    public function firstUpdatedFirst(){
        return $this->addAscendingOrderByColumn(MenuPeer::DATE_MODIFICATION);
    }
    ...
    public function recentlyCreated($nbDays = 7){
        return $this->addUsingAlias(MenuPeer::DATE_CREATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastCreatedFirst(){
        return $this->addDescendingOrderByColumn(MenuPeer::DATE_CREATION);
    }
    ...
    public function firstCreatedFirst(){
        return $this->addAscendingOrderByColumn(MenuPeer::DATE_CREATION);
    }
}
