...
abstract class BaseRegionQuery extends ModelCriteria
{
    ...
    {
        if ($criteria instanceof RegionQuery) {return $criteria;}
        $query = new RegionQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT `id_region`, `id_province`, `title`, `id_creation`, `id_modification` FROM `region` WHERE `id_region` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(RegionPeer::ID_REGION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(RegionPeer::ID_REGION, $keys, Criteria::IN);
    }
    ...
    public function filterByIdRegion($idRegion = null, $comparison = null)
    {
        if (is_array($idRegion)) {
            ...
            if (isset($idRegion['min'])) {
                $this->addUsingAlias(RegionPeer::ID_REGION, $idRegion['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idRegion['max'])) {
                $this->addUsingAlias(RegionPeer::ID_REGION, $idRegion['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionPeer::ID_REGION, $idRegion, $comparison);
    }
    ...
    public function filterByIdProvince($idProvince = null, $comparison = null)
    {
        if (is_array($idProvince)) {
            ...
            if (isset($idProvince['min'])) {
                $this->addUsingAlias(RegionPeer::ID_PROVINCE, $idProvince['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idProvince['max'])) {
                $this->addUsingAlias(RegionPeer::ID_PROVINCE, $idProvince['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionPeer::ID_PROVINCE, $idProvince, $comparison);
    }
    ...
    public function filterByDateCreation($dateCreation = null, $comparison = null)
    {
        if (is_array($dateCreation)) {
            ...
            if (isset($dateCreation['min'])) {
                $this->addUsingAlias(RegionPeer::DATE_CREATION, $dateCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateCreation['max'])) {
                $this->addUsingAlias(RegionPeer::DATE_CREATION, $dateCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionPeer::DATE_CREATION, $dateCreation, $comparison);
    }
    ...
    public function filterByDateModification($dateModification = null, $comparison = null)
    {
        if (is_array($dateModification)) {
            ...
            if (isset($dateModification['min'])) {
                $this->addUsingAlias(RegionPeer::DATE_MODIFICATION, $dateModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateModification['max'])) {
                $this->addUsingAlias(RegionPeer::DATE_MODIFICATION, $dateModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionPeer::DATE_MODIFICATION, $dateModification, $comparison);
    }
    ...
    public function filterByIdCreation($idCreation = null, $comparison = null)
    {
        if (is_array($idCreation)) {
            ...
            if (isset($idCreation['min'])) {
                $this->addUsingAlias(RegionPeer::ID_CREATION, $idCreation['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idCreation['max'])) {
                $this->addUsingAlias(RegionPeer::ID_CREATION, $idCreation['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionPeer::ID_CREATION, $idCreation, $comparison);
    }
    ...
    public function filterByIdModification($idModification = null, $comparison = null)
    {
        if (is_array($idModification)) {
            ...
            if (isset($idModification['min'])) {
                $this->addUsingAlias(RegionPeer::ID_MODIFICATION, $idModification['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idModification['max'])) {
                $this->addUsingAlias(RegionPeer::ID_MODIFICATION, $idModification['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionPeer::ID_MODIFICATION, $idModification, $comparison);
    }
    ...
    public function filterByProvince($province, $comparison = null)
    {
        if ($province instanceof Province) {
            return $this
                ->addUsingAlias(RegionPeer::ID_PROVINCE, $province->getIdProvince(), $comparison);
            ...
            return $this
                ->addUsingAlias(RegionPeer::ID_PROVINCE, $province->toKeyValue('PrimaryKey', 'IdProvince'), $comparison);
        } else {
    ...
    public function filterByAccount($account, $comparison = null)
    {
        if ($account instanceof Account) {
            return $this
                ->addUsingAlias(RegionPeer::ID_REGION, $account->getIdRegion(), $comparison);
    ...
    public function filterByVille($ville, $comparison = null)
    {
        if ($ville instanceof Ville) {
            return $this
                ->addUsingAlias(RegionPeer::ID_REGION, $ville->getIdRegion(), $comparison);
    ...
    public function filterByRegionI18n($regionI18n, $comparison = null)
    {
        if ($regionI18n instanceof RegionI18n) {
            return $this
                ->addUsingAlias(RegionPeer::ID_REGION, $regionI18n->getIdRegion(), $comparison);
    ...
    public function useRegionI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'RegionI18n', 'RegionI18nQuery');
    }
    ...
    {
        if ($region) {
            $this->addUsingAlias(RegionPeer::ID_REGION, $region->getIdRegion(), Criteria::NOT_EQUAL);
        }
    ...
    public function recentlyUpdated($nbDays = 7){
        return $this->addUsingAlias(RegionPeer::DATE_MODIFICATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastUpdatedFirst(){
        return $this->addDescendingOrderByColumn(RegionPeer::DATE_MODIFICATION);
    }
    ...
    public function firstUpdatedFirst(){
        return $this->addAscendingOrderByColumn(RegionPeer::DATE_MODIFICATION);
    }
    ...
    public function recentlyCreated($nbDays = 7){
        return $this->addUsingAlias(RegionPeer::DATE_CREATION, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    public function lastCreatedFirst(){
        return $this->addDescendingOrderByColumn(RegionPeer::DATE_CREATION);
    }
    ...
    public function firstCreatedFirst(){
        return $this->addAscendingOrderByColumn(RegionPeer::DATE_CREATION);
    }
}
