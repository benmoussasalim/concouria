...
abstract class BasePaysI18n extends BaseObject implements Persistent
{
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(PaysI18nPeer::DATE_CREATION);
        try {
            $stmt = PaysI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(PaysI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = PaysI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdPays($v)
    {
        ...
        if ($this->id_pays !== $v) {
            $this->id_pays = $v;
            $this->modifiedColumns[] = PaysI18nPeer::ID_PAYS;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = PaysI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = PaysI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = PaysI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = PaysI18nPeer::ID_MODIFICATION;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(PaysI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='PaysI18n';}
        $needeRight='d';
        ...
        if ($con === null) { $con = Propel::getConnection(PaysI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = PaysI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PaysI18nPeer::ID_PAYS)) {
        ...
        if ($this->isColumnModified(PaysI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(PaysI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(PaysI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(PaysI18nPeer::ID_MODIFICATION)) {
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = PaysI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaysI18nPeer::ID_PAYS)) $criteria->add(PaysI18nPeer::ID_PAYS, $this->id_pays);
        ...
        if ($this->isColumnModified(PaysI18nPeer::DATE_CREATION)) $criteria->add(PaysI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(PaysI18nPeer::DATE_MODIFICATION)) $criteria->add(PaysI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(PaysI18nPeer::ID_CREATION)) $criteria->add(PaysI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(PaysI18nPeer::ID_MODIFICATION)) $criteria->add(PaysI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(PaysI18nPeer::DATABASE_NAME);
        $criteria->add(PaysI18nPeer::ID_PAYS, $this->id_pays);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdPays()) && (null === $this->getLocale());
    }
