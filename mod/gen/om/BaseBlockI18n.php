...
/**
 * Base class that represents a row from the 'block_i18n' table.
 *
 *
 *
 * @package    propel.generator.gen.om
 */
abstract class BaseBlockI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'BlockI18nPeer';
    ...
    /**
     * Initializes internal state of BaseBlockI18n object.
     * @see        applyDefaults()
     */
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(BlockI18nPeer::DATE_CREATION);
        try {
            $stmt = BlockI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(BlockI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = BlockI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdBlock($v)
    {
        ...
        if ($this->id_block !== $v) {
            $this->id_block = $v;
            $this->modifiedColumns[] = BlockI18nPeer::ID_BLOCK;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = BlockI18nPeer::LOCALE;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = BlockI18nPeer::TEXT;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = BlockI18nPeer::VERSION;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = BlockI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = BlockI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = BlockI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = BlockI18nPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = BlockI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BlockI18n object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(BlockI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.
        $stmt = BlockI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='BlockI18n';}
        $needeRight='d';
        ...
        if ($con === null) { $con = Propel::getConnection(BlockI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = BlockI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->commit();
            BlockI18nPeer::addInstanceToPool($this);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BlockI18nPeer::ID_BLOCK)) {
            $modifiedColumns[':p' . $index++]  = '`id_block`';
        }
        if ($this->isColumnModified(BlockI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(BlockI18nPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(BlockI18nPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }
        if ($this->isColumnModified(BlockI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(BlockI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(BlockI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(BlockI18nPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `block_i18n` (%s) VALUES (%s)',
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = BlockI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        $pos = BlockI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BlockI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BlockI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = BlockI18nPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BlockI18nPeer::ID_BLOCK)) $criteria->add(BlockI18nPeer::ID_BLOCK, $this->id_block);
        if ($this->isColumnModified(BlockI18nPeer::LOCALE)) $criteria->add(BlockI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(BlockI18nPeer::TEXT)) $criteria->add(BlockI18nPeer::TEXT, $this->text);
        if ($this->isColumnModified(BlockI18nPeer::VERSION)) $criteria->add(BlockI18nPeer::VERSION, $this->version);
        if ($this->isColumnModified(BlockI18nPeer::DATE_CREATION)) $criteria->add(BlockI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(BlockI18nPeer::DATE_MODIFICATION)) $criteria->add(BlockI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(BlockI18nPeer::ID_CREATION)) $criteria->add(BlockI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(BlockI18nPeer::ID_MODIFICATION)) $criteria->add(BlockI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(BlockI18nPeer::DATABASE_NAME);
        $criteria->add(BlockI18nPeer::ID_BLOCK, $this->id_block);
        $criteria->add(BlockI18nPeer::LOCALE, $this->locale);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdBlock()) && (null === $this->getLocale());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BlockI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BlockI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BlockI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BlockI18nPeer();
        }
    ...
    public function getBlock(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBlock === null && ($this->id_block !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBlock->addBlockI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BlockI18nPeer::DEFAULT_STRING_FORMAT);
    }
