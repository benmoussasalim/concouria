...
abstract class BaseRegionI18n extends BaseObject implements Persistent
{
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(RegionI18nPeer::DATE_CREATION);
        try {
            $stmt = RegionI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(RegionI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = RegionI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdRegion($v)
    {
        ...
        if ($this->id_region !== $v) {
            $this->id_region = $v;
            $this->modifiedColumns[] = RegionI18nPeer::ID_REGION;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = RegionI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = RegionI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = RegionI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = RegionI18nPeer::ID_MODIFICATION;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(RegionI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='RegionI18n';}
        $needeRight='d';
        ...
        mem_clean('RegionI18n');

        if ($this->isDeleted()) { throw new PropelException("This object has already been deleted.");}
        if ($con === null) { $con = Propel::getConnection(RegionI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = RegionI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RegionI18nPeer::ID_REGION)) {
        ...
        if ($this->isColumnModified(RegionI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(RegionI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(RegionI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(RegionI18nPeer::ID_MODIFICATION)) {
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = RegionI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionI18nPeer::ID_REGION)) $criteria->add(RegionI18nPeer::ID_REGION, $this->id_region);
        ...
        if ($this->isColumnModified(RegionI18nPeer::DATE_CREATION)) $criteria->add(RegionI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(RegionI18nPeer::DATE_MODIFICATION)) $criteria->add(RegionI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(RegionI18nPeer::ID_CREATION)) $criteria->add(RegionI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(RegionI18nPeer::ID_MODIFICATION)) $criteria->add(RegionI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(RegionI18nPeer::DATABASE_NAME);
        $criteria->add(RegionI18nPeer::ID_REGION, $this->id_region);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdRegion()) && (null === $this->getLocale());
    }
