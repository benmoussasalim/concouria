...
/**
 * Base class that represents a row from the 'province_i18n' table.
 *
 *
 *
 * @package    propel.generator.gen.om
 */
abstract class BaseProvinceI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProvinceI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProvinceI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseProvinceI18n object.
     * @see        applyDefaults()
     */
    ...
    protected function loadDateCreation(PropelPDO $con = null)
    {
        ...
        $c->addSelectColumn(ProvinceI18nPeer::DATE_CREATION);
        try {
            $stmt = ProvinceI18nPeer::doSelectStmt($c, $con);
    ...
    {
        $c = $this->buildPkeyCriteria();
        $c->addSelectColumn(ProvinceI18nPeer::DATE_MODIFICATION);
        try {
            $stmt = ProvinceI18nPeer::doSelectStmt($c, $con);
            $row = $stmt->fetch(PDO::FETCH_NUM);
            $stmt->closeCursor();
    ...
    public function setIdProvince($v)
    {
        ...
        if ($this->id_province !== $v) {
            $this->id_province = $v;
            $this->modifiedColumns[] = ProvinceI18nPeer::ID_PROVINCE;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = ProvinceI18nPeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProvinceI18nPeer::NAME;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if (!$this->date_creation_isLoaded && $v === null) {
            $this->modifiedColumns[] = ProvinceI18nPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if (!$this->date_modification_isLoaded && $v === null) {
            $this->modifiedColumns[] = ProvinceI18nPeer::DATE_MODIFICATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = ProvinceI18nPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = ProvinceI18nPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = ProvinceI18nPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProvinceI18n object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null){
        ...
        if ($con === null) { $con = Propel::getConnection(ProvinceI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);}
        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.
        $stmt = ProvinceI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        $row = $stmt->fetch(PDO::FETCH_NUM);
        $stmt->closeCursor();
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION['CurrentRights']){$_SESSION['CurrentRights']='ProvinceI18n';}
        $needeRight='d';
        ...
        mem_clean('ProvinceI18n');

        if ($this->isDeleted()) { throw new PropelException("This object has already been deleted.");}
        if ($con === null) { $con = Propel::getConnection(ProvinceI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);}
        $con->beginTransaction();
        try {
            $deleteQuery = ProvinceI18nQuery::create()->filterByPrimaryKey($this->getPrimaryKey());
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->commit();
            ProvinceI18nPeer::addInstanceToPool($this);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProvinceI18nPeer::ID_PROVINCE)) {
            $modifiedColumns[':p' . $index++]  = '`id_province`';
        }
        if ($this->isColumnModified(ProvinceI18nPeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(ProvinceI18nPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProvinceI18nPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(ProvinceI18nPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(ProvinceI18nPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(ProvinceI18nPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `province_i18n` (%s) VALUES (%s)',
...
// TableStampBehavior behavior
        ...
        if(!$_SESSION[_AUTH_VAR]->hasRights($_SESSION['CurrentRights'],$needeRight,$this)){
            ...
            if (($retval = ProvinceI18nPeer::doValidate($this, $columns)) !== true){$failureMap = array_merge($failureMap, $retval);}
    ...
    {
        $pos = ProvinceI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProvinceI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProvinceI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = ProvinceI18nPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProvinceI18nPeer::ID_PROVINCE)) $criteria->add(ProvinceI18nPeer::ID_PROVINCE, $this->id_province);
        if ($this->isColumnModified(ProvinceI18nPeer::LOCALE)) $criteria->add(ProvinceI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(ProvinceI18nPeer::NAME)) $criteria->add(ProvinceI18nPeer::NAME, $this->name);
        if ($this->isColumnModified(ProvinceI18nPeer::DATE_CREATION)) $criteria->add(ProvinceI18nPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(ProvinceI18nPeer::DATE_MODIFICATION)) $criteria->add(ProvinceI18nPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(ProvinceI18nPeer::ID_CREATION)) $criteria->add(ProvinceI18nPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(ProvinceI18nPeer::ID_MODIFICATION)) $criteria->add(ProvinceI18nPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(ProvinceI18nPeer::DATABASE_NAME);
        $criteria->add(ProvinceI18nPeer::ID_PROVINCE, $this->id_province);
        $criteria->add(ProvinceI18nPeer::LOCALE, $this->locale);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdProvince()) && (null === $this->getLocale());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProvinceI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProvinceI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProvinceI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProvinceI18nPeer();
        }
    ...
    public function getProvince(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProvince === null && ($this->id_province !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProvince->addProvinceI18ns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProvinceI18nPeer::DEFAULT_STRING_FORMAT);
    }
