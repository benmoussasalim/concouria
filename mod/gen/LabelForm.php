...
try{$dataObj->getTranslation('en_US');}catch (Exception $exep){$mt = new LabelI18n();$mt->setLocale('en_US')->setText('');$dataObj->addLabelI18n($mt)->save();}
        ...
        textarea('Reference',$dataObj->getReference() ,"placeholder='".str_replace("'","&#39;",_('Reference'))."' cols='71' otherTabs=1 v='REFERENCE' s='d'  class='' style='' spellcheck='false'"), 'Reference', "", @$this->commentsReference, @$this->commentsReference_css, ' istinymce', ' ','no','');
            ...
            $this->fields['Label']['LabelI18n_Text_frCA']['html'] = stdFieldRow(_("Label français"), 
        ...
        $ongletf =
            div(
                ul(li(htmlLink(_('Label'),'#ogf_Label',' j="ogf" p="Label" class="ui-tabs-anchor button-link-blue" ')).li(htmlLink(_('Français'),'#ogf_Labeli18nTextFrca',' j="ogf" class="ui-tabs-anchor button-link-blue" p="Label" ')).li(htmlLink(_('Anglais'),'#ogf_Labeli18nTextEnus',' j="ogf" class="ui-tabs-anchor button-link-blue" p="Label" ')))
...
$this->fieldsRo['Label']['LabelI18n_Text_frCA']['html'] = stdFieldRow(_("Label français"), textarea('LabelI18n_Text_frCA',$dataObj->getTranslation('fr_CA')->getText()," readonly class=''    s='d'"), 'LabelI18n_Text_frCA', "", @$this->commentsLabelI18n_Text_frCA, @$this->commentsLabelI18n_Text_frCA_css, 'readonly istinymce', ' ','no','');
